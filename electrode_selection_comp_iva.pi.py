...
DATASET_FOLDER = "dataset_comp"
data = np.load(f'./{DATASET_FOLDER}/aa.npz')
...
#     distances=distances, epsilon=0.05, sigma=1, coordinates=eeg_pos)
# grafo_4.plot()
...
np.save('subgrafos_1.npy', subgrafos_1, allow_pickle=True)
...
np.save('subgrafos_2.npy', subgrafos_2, allow_pickle=True)
...
np.save('subgrafos_3.npy', subgrafos_3, allow_pickle=True)
