...
DATASET_FOLDER = "data"
data = np.load(f'./{DATASET_FOLDER}/task_2/mne_dataset_1_8-30.npz')
...
grafo_2 = comp_eeg.compute_graph(
    distances=distances, epsilon=0.25, sigma=0.1, coordinates=eeg_pos)
grafo_2.plot()

grafo_3 = comp_eeg.compute_graph(
    distances=distances, epsilon=0.27, sigma=0.25, coordinates=eeg_pos)
grafo_3.plot()
